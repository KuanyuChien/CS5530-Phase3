...
namespace LMS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            // Collect all existing uIDs across all three tables to find the next available number
            var allIds = db.Students.Select(s => s.UId)
                           .Union(db.Professors.Select(p => p.UId))
