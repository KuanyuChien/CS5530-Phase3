        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Assignment>(entity =>
            {
                ...
                entity.HasOne(d => d.CategoryNavigation)
                    ...
                    .HasConstraintName("fk_Assignments_AssignmentCategories");
            });
            ...
            modelBuilder.Entity<AssignmentCategory>(entity =>
            {
                ...
                entity.HasOne(d => d.InClassNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_AssignmentCategories_Classes");
            });
            ...
            modelBuilder.Entity<Class>(entity =>
            {
                ...
                entity.HasIndex(e => e.Season, "Season");
            ...
            modelBuilder.Entity<Enrolled>(entity =>
            {
                ...
                entity.HasIndex(e => e.Class, "fk_Enrolled_Classes");
                ...
                entity.HasOne(d => d.ClassNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_Enrolled_Classes");

                entity.HasOne(d => d.StudentNavigation)
                    .WithMany(p => p.Enrolleds)
                    .HasForeignKey(d => d.Student)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_Enrolled_Students");
            });
            ...
            modelBuilder.Entity<Submission>(entity =>
            {
                ...
                entity.HasIndex(e => e.Student, "fk_Submissions_Students");
