    ...
    public class StudentController : Controller
    {
        ...
        public IActionResult GetAssignmentsInClass(string subject, int num, string season, int year, string uid)
        {
            var query1 = from co in db.Courses
                         ...
                         select new { assignmentId = a.AssignmentId, aname = a.Name, cname = ac.Name, due = a.Due };
            ...
            var query2 = from q in query1
                         ...
                         select new { q.aname, q.cname, q.due, score = (uint?)j.Score };
          ...
          string category, string asgname, string uid, string contents)
        {
            ...
            var existing = db.Submissions.FirstOrDefault(s => s.Assignment == asg.AssignmentId && s.Student == uid);
            if (existing != null)
            {
        ...
        private static double GradeToPoints(string grade)
        {
            switch (grade)
            {
                ...
                case "D":  return 1.0;
                case "D-": return 0.7;
                default:   return 0.0; // "E" and anything unexpected
            }
        }
